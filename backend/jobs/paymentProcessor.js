...
function initPaymentWorker() {
    if (worker) return; // Singletone protection

    console.log('👷 [PaymentProcessor] Iniciando Worker de Pagamentos (In-Process)...');
...
module.exports = { enqueuePaymentJob, initPaymentWorker };
